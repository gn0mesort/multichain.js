/*
 * commands.js
 * Defines a properly formatted commands object for jsonrpc.js
 * Because require() is capable of parsing JSON files this file may also be defined as a JSON file with equivalent syntax
 *
 * Basic syntax is:
 * {
 *  methodName: ['param1', 'param2', {'optionalParam': 'defautlValue'}]
 * }
 *
 * Parameter names are merely placeholders and do not need to match any documented parameter names
 * Default Parameter objects will only have their first value read. To default to an object with multiple properties nest the object as the first property of the default parameter
 * Method names are used in sending requests and must match documented method names
 *
